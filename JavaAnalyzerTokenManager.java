/* JavaAnalyzerTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. JavaAnalyzerTokenManager.java */
import java.io.FileReader;
import java.io.IOException;

/** Token Manager. */
@SuppressWarnings("unused")public class JavaAnalyzerTokenManager implements JavaAnalyzerConstants {
...
private final int jjStopStringLiteralDfa_0(int pos, long active0){
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0x488L) != 0L)
            return 1;
         if ((active0 & 0x3b52L) != 0L)
         {
            jjmatchedKind = 14;
            jjmatchedPos = 3;
            return 1;
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0){
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x1410L);
      case 108:
...
private int jjMoveStringLiteralDfa3_0(long old0, long active0){
   ...
   switch(curChar)
   {
      ...
      case 101:
         ...
         break;
      case 108:
         return jjMoveStringLiteralDfa4_0(active0, 0x850L);
      case 115:
         return jjMoveStringLiteralDfa4_0(active0, 0x102L);
      case 116:
...
"", "\143\154\141\163\163", "\151\146", "\145\154\163\145", 
"\167\150\151\154\145", "\151\156\164", "\142\157\157\154\145\141\156", "\164\162\165\145", 
"\146\141\154\163\145", "\162\145\164\165\162\156", "\166\157\151\144", "\160\165\142\154\151\143", 
"\160\162\151\166\141\164\145", "\163\164\141\164\151\143", null, null, null, "\53", "\55", "\52", "\57", 
"\75", "\75\75", "\74", "\76", "\50", "\51", "\173", "\175", "\73", "\54", null, null, 
null, null, null, null, };
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public JavaAnalyzerTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public JavaAnalyzerTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
